...
from build_pointcloud_dataset import scan_cases, filter_paired  # reutilizamos helpers
...
def main():
    ...
    ap.add_argument("--dataset_dir", required=True, help="data/3dteethseg/processed_flat")
    ap.add_argument("--id_regex", default=None, help="Regex con grupo capturado para pid, ej: '^([A-Za-z0-9]+)_'")
    ap.add_argument("--split_char", default=None, help="Alternativa simple a regex: separador para pid")
    ap.add_argument("--split_index", type=int, default=0, help="Parte a usar como pid si usas split_char")
    ...
    print("[OK] JSON:", args.out_json)

    # CSV de resumen simple
    summary_rows = [{
    ...
    print("[OK] CSV missing:", args.out_csv_missing)
