...
"""
train_dgcnn_classic_only_fixed_v11.py
...
Notas v11 (fixes reales vs v10 pegoteado):
- Eliminadas definiciones duplicadas.
- setup_logging ahora es SOLO logger estándar (run.log + errors.log + console).
- eval_neighbors_on_loader firma consistente.
- knn chunk-safe mantiene [B,N,k] correcto (query-chunks vs keys completos).
"""
...
def setup_logging(out_dir: Path, name: str = "dgcnn_v11") -> Logger:
...
# ============================================================
# Checkpoints (FIX: faltaban en v11)
# ============================================================
...
# ============================================================
# Evaluación loader completo (VAL / TEST)
# ============================================================
...
# ============================================================
# Métricas vecinos (lista arbitraria)
# ============================================================
...
# ============================================================
# PARTE 4/5 — TRAIN LOOP + CHECKPOINTS + HISTORY/CSV + PLOTS
# ============================================================
...
# ============================================================
# PARTE 5/5 — MAIN + META + TEST + INFERENCIA PAPER-LIKE
# ============================================================
...
# ============================================================
# INFERENCIA PAPER-LIKE (ALL / ERRORS / D21)
# ============================================================
...
def infer_and_save_examples_paperlike(
    ...
    with manifest_csv.open("a", newline="", encoding="utf-8") as f:
        ...
        for bidx, (xyz, lab) in enumerate(loader):
            ...
            name = f"{split}_{bidx:04d}"
            if index_map and bidx in index_map:
                name = pick_trace_label(index_map[bidx])
...
def main():
    ...
    logger = setup_logging(out_dir, name="dgcnn_v11")
    ...
    run_meta = {
        "timestamp": now_iso(),
        "script": "train_dgcnn_classic_only_fixed_v11.py",
        "args": vars(args),
        "extra": {
            "num_classes": C,
            "bg": bg,
