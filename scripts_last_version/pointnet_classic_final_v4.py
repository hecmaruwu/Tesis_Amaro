...
Ejemplo:
python3 pointnet_classic_final_v4.py \
...
def main():
    ...
    # =========================================================
    run_meta = {
        "script_name": "pointnet_classic_final_v4.py",
    ...
    # =========================================================
    # TEST (best checkpoint) + PLOTS (SIN test-line) + INFERENCIA
    # =========================================================
    ...
    # en test recolectamos std por batch
    te = run_epoch(
            ...
            with torch.no_grad():
                for r, i in enumerate(idxs, start=1):
                    ...
                    title = (
                        ...
                        f"best_epoch={int(best_epoch)} | C={C} | d21={int(d21_int)}"
                    )
