...
"""
pointnettransformer_classic_final_v5_patch_v2.py
...
def main():
    ...
    # =========================================================
    run_meta = {
        "script_name": "pointnettransformer_classic_final_v5_patch_v2.py",
    ...
    if args.infer_only:
        ...
        if "model" in ckpt:
            ...
            raise KeyError(f"Checkpoint sin 'model' ni 'model_state': {best_path}")
