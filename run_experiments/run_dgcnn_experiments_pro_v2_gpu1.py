...
Runner "nivel pro v2" para barrer experimentos de DGCNN de forma secuencial,
...
Pensado para:
  /home/htaucare/Tesis_Amaro/scripts_last_version/train_dgcnn_classic_only_fixed_v9_patch.py
"""
...
RUNS_ROOT = "/home/htaucare/Tesis_Amaro/outputs/dgcnn/grid_pro_runner_v2_gpu1"
LOGS_ROOT = "/home/htaucare/Tesis_Amaro/outputs/dgcnn/grid_pro_runner_v2_gpu1/logs"
...
EXPERIMENT_GRID: List[Dict[str, Any]] = [
    {"name": "exp01_bs8_lr2e4_k20_emb1024_bg003", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp02_bs8_lr1e4_k20_emb1024_bg003", "--batch_size": 8, "--lr": 1e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp03_bs8_lr3e4_k20_emb1024_bg003", "--batch_size": 8, "--lr": 3e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp04_bs8_lr2e4_k16_emb1024_bg003", "--batch_size": 8, "--lr": 2e-4, "--k": 16, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp05_bs8_lr2e4_k24_emb1024_bg003", "--batch_size": 8, "--lr": 2e-4, "--k": 24, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp06_bs8_lr2e4_k20_emb768_bg003", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 768, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp07_bs8_lr2e4_k20_emb512_bg003", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 512, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp08_bs4_lr2e4_k20_emb1024_bg003", "--batch_size": 4, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.03},
    {"name": "exp09_bs8_lr2e4_k20_emb1024_bg001", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.01},
    {"name": "exp10_bs8_lr2e4_k20_emb1024_bg005", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.5, "--bg_weight": 0.05},
    {"name": "exp11_bs8_lr2e4_k20_emb1024_do03", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.3, "--bg_weight": 0.03},
    {"name": "exp12_bs8_lr2e4_k20_emb1024_do06", "--batch_size": 8, "--lr": 2e-4, "--k": 20, "--emb_dims": 1024, "--dropout": 0.6, "--bg_weight": 0.03},
]
...
def collect_result(
    ...
    elapsed_sec: Optional[float],
    cmd_shell: str,
    attempted_batch_size: Optional[int],
    retries: int,
    oom_detected: bool,
