...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument(
        "--out_dir",
        default=None,
        help="Carpeta de salida. Default: <base_dir>/VISTA_TESIS_INFERENCIA_AJUSTADA_V2 (misma salida/base que la versión actual).",
    )
    ap.add_argument(
        "--selected_mesh_root",
    ...
    ap.add_argument("--point_opacity", type=float, default=1.0)
    ...
    for case_dir in case_dirs:
        ...
        for model in models:
            ...
            for view_name, camera in views.items():
                ...
                summary = {
                    "script": "vista_tesis_inferencia_ajustada_v4_visual_v17.py",
