...
Runner v2 para barrer experimentos de PointNet-Transformer de forma secuencial,
guardar logs, resumir métricas, rankear resultados y elegir automáticamente
el mejor experimento.

Adaptado al script base real:
...
RUNS_ROOT = "/home/htaucare/Tesis_Amaro/outputs/pointnettransformer/grid_pro_runner_v2_gpu0"
LOGS_ROOT = "/home/htaucare/Tesis_Amaro/outputs/pointnettransformer/grid_pro_runner_v2_gpu0/logs"
...
BASE_ARGS: Dict[str, Any] = {
    "--data_dir": DATA_DIR,
    "--epochs": 120,
    "--batch_size": 4,              # más prudente para Transformer en 3090
    "--lr": 2e-4,
    "--weight_decay": 1e-4,
    "--num_workers": 6,
    "--infer_num_workers": 0,
    "--device": "cuda",
    "--seed": 42,
    "--use_amp": True,              # en 3090 suele convenir
    "--grad_clip": 1.0,
    "--bg_index": 0,
    "--bg_weight": 0.03,
    "--d21_internal": 8,
...
EXPERIMENT_GRID: List[Dict[str, Any]] = [
    {
        "name": "exp01_bs4_lr2e4_dm256_dep4_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp02_bs4_lr1e4_dm256_dep4_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 1e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp03_bs4_lr3e4_dm256_dep4_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 3e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp04_bs4_lr2e4_dm192_dep4_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 192,
        "--depth": 4,
    ...
    {
        "name": "exp05_bs4_lr2e4_dm320_dep4_h8_ff640_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 320,
        "--depth": 4,
    ...
    {
        "name": "exp06_bs4_lr2e4_dm256_dep3_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 3,
    ...
    {
        "name": "exp07_bs4_lr2e4_dm256_dep5_h8_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 5,
    ...
    {
        "name": "exp08_bs4_lr2e4_dm256_dep4_h4_ff512_tok2048",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp09_bs4_lr2e4_dm256_dep4_h8_ff512_tok1024",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
        "--nhead": 8,
        "--dim_feedforward": 512,
        "--token_subsample": 1024,
        "--dropout": 0.1,
        "--head_dropout": 0.1,
    },
    {
        "name": "exp10_bs4_lr2e4_dm256_dep4_h8_ff512_tok3072",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
        "--nhead": 8,
        "--dim_feedforward": 512,
        "--token_subsample": 3072,
        "--dropout": 0.1,
        "--head_dropout": 0.1,
    },
    {
        "name": "exp11_bs4_lr2e4_dm256_dep4_h8_ff512_bg001",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp12_bs4_lr2e4_dm256_dep4_h8_ff512_bg005",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp13_bs4_lr2e4_dm256_dep4_h8_ff512_do005",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
    ...
    {
        "name": "exp14_bs4_lr2e4_dm256_dep4_h8_ff512_do020",
        "--batch_size": 4,
        "--lr": 2e-4,
        "--d_model": 256,
        "--depth": 4,
...
def main():
    ...
    for i, exp0 in enumerate(EXPERIMENT_GRID, start=1):
        ...
        retries = 0
        final_result = None
        attempted_bs = int(exp.get("--batch_size", 4))
        last_reason = None
