...
# -*- coding: utf-8 -*-
"""
PointNet++ Binary (v19c)
Corrección final:
- Se crean capas MLP en __init__, no en forward.
- Evita mezcla de tensores CPU/GPU.
- Split reproducible, sin fugas, con métricas globales.
"""
...
def main():
    ...
    ap.add_argument("--name", default="runs_pointnet2_binary_cls_v19c")
