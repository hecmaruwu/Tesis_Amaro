...
# -*- coding: utf-8 -*-
"""
train_models_v2_patience.py (v1.5 – EarlyStopping integrado)

Incluye:
- Mecanismo de paciencia (early stopping)
- ReduceLROnPlateau + parada anticipada basada en val_loss
- Igual arquitectura y lógica de v2
...
class EarlyStopping:
    """
    Detiene el entrenamiento cuando el val_loss deja de mejorar.
    Guarda el mejor modelo y corta tras `patience` épocas sin mejora.
    """
...
def train_model(model_name: str, loaders, num_classes: int, args, device, base_outdir: Path):
    ...
    if best_ckpt.exists():
        ...
        # por seguridad, si nunca mejoró, usar último
